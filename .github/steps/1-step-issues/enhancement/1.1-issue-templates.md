...
Make a series of issue template forms for common tasks. Make sure enough details are required so Copilot cloud agent can easily be assigned these tasks without further explanation.
